...
Rails.application.configure do
  ...
  config.hosts << "work-1-rlmvgveowwxsbetc.prod-runtime.all-hands.dev"
  config.hosts << "work-2-rlmvgveowwxsbetc.prod-runtime.all-hands.dev"
  ...
  # config.active_job.queue_name_prefix = "mystandmap_production"
